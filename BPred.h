...
SESC is free software; you can redistribute it andor modify it under the terms
...
#include GStats.h
#include libllInstruction.h         InstID
#include CacheCore.h
#include EnergyMgr.h
#include SCTable.h
...
private
    ...
    typedef CacheGenericBTBState, uint32_t, false BTBCache;
...
protected
public
    BPHier(int32_t i, int32_t fetchWidth, const char section);
    ~BPHier();
